...
public class FeatureMesh {
    ...
    private FeatureMesh(int vaoId, int vboId, int eboId, int indexCount) {
        this.vaoId = vaoId;
        this.vboId = vboId;
        this.eboId = eboId;
    ...
    public static FeatureMesh upload(FeatureMeshData data) {
        ...
        return new FeatureMesh(vao, vbo, ebo, data.indices().length);
    }
